...
if (hspeed != 0) {
	...
	sprite_index = spr_water_priestess_surf;
}


if(distance_to_object(obj_player) < 5) && canAttack = true{
	health -= 10;
	sprite_index = spr_water_priestess_attack;
	canAttack = false;
	alarm[0] = 50;
}
...
// Allows water priestess to heal
if (obj_water_priestess.health <= 20) {
	obj_water_priestess.health += 50;
	sprite_index = spr_water_priestess_heal;
	canMove = false;
	alarm[2] = 200;
}
...
if (obj_water_priestess.health <= 0){instance_destroy();}
